...
class PendaftaranController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (count($pendaftarans_review_acc) != 0) {
            ...
            $validatedData = $request->validate([
                ...
                'sertifikat_peserta_1' => ['required', 'mimes:pdf', 'max:5000'],
                'sertifikat_peserta_2' => ['required', 'mimes:pdf', 'max:5000'],
            ]);
            ...
            $validatedData['sertifikat_peserta_1'] = AppHelper::instance()->uploadLampiran($request->file('sertifikat_peserta_1'), 'lampirans', $mahasiswa->nim, 'pendaftaran');
            $validatedData['sertifikat_peserta_2'] = AppHelper::instance()->uploadLampiran($request->file('sertifikat_peserta_2'), 'lampirans', $mahasiswa->nim, 'pendaftaran');
    ...
    public function update(Request $request)
    {
        ...
        $validatedData = $request->validate([
            ...
            'sertifikat_peserta_1' => [Rule::requiredIf(function () {
                if (empty($this->request->sertifikat_peserta_1)) {return false;}
                return true;
            }), 'mimes:pdf', 'max:5000'],
            'sertifikat_peserta_2' => [Rule::requiredIf(function () {
                if (empty($this->request->sertifikat_peserta_2)) {return false;}
                return true;
            }), 'mimes:pdf', 'max:5000'],
        ]);
        ...
        if ($request->file('sertifikat_peserta_1')) {
             if($pendaftaran->sertifikat_peserta_1) AppHelper::instance()->deleteLampiran($pendaftaran->sertifikat_peserta_1);
            $validatedData['sertifikat_peserta_1'] = AppHelper::instance()->uploadLampiran($request->sertifikat_peserta_1, 'lampirans', $mahasiswa->nim, 'pendaftaran');
        }
        if ($request->file('sertifikat_peserta_2')) {
             if($pendaftaran->sertifikat_peserta_2) AppHelper::instance()->deleteLampiran($pendaftaran->sertifikat_peserta_2);
            $validatedData['sertifikat_peserta_2'] = AppHelper::instance()->uploadLampiran($request->sertifikat_peserta_2, 'lampirans', $mahasiswa->nim, 'pendaftaran');
        }
