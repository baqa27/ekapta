...
class PenilaianPembimbingController extends Controller
{
    ...
    public function create($mahasiswa_id)
    {
        ...
        return view('pages.dosen.penilaian.create', [
    ...
    public function store(Request $request)
    {
        ...
        $dosen = Dosen::findOrFail(Auth::guard('dosen')->user()->id);
        $mahasiswa = Mahasiswa::with(['jilid'])->findOrFail($request->mahasiswa_id);
        ...
        return redirect()->route('penilaian.pembimbing.index')->with('success', 'Nilai pembimbing berhasil disimpan');
    }
}
