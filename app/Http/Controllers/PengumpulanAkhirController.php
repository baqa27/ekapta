...
class PengumpulanAkhirController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('pengumpulan-akhir.mahasiswa')->with('success', 'Pengajuan pengumpulan akhir berhasil. Silahkan tunggu validasi dari Admin');
    }
    ...
    public function edit($id)
    {
        ...
        return view('pages.pengumpulan-akhir.edit', [
    ...
    public function acc(Request $request, $id)
    {
        ...
        return redirect()->route('pengumpulan-akhir.index')->with('success', 'Pengajuan pengumpulan akhir berhasil di update');
    }
    ...
    public function confirmCompleted($id)
    {
        ...
        return redirect()->route('pengumpulan-akhir.index')->with('success', 'Konfirmasi setor ke perpus berhasil disimpan');
    }
}
