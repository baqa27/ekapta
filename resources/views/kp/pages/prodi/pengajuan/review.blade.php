...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="mb-3">
                <a href="{{ route('kp.pengajuan.prodi') }}" class="btn btn-secondary shadow">
                ...
                <div class="col-12">
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-footer">
                            <div class="d-flex">
                                <a href="{{ route('kp.pengajuan.prodi') }}" class="btn btn-secondary mr-2">
                                ...
                                @if ($pengajuan->status == 'review')
                                    ...
                                    {{--<div onclick="confirmAcc()">
                                        <form action="{{ route('kp.pengajuan.acc') }}" method="post">
                                            @csrf
                                ...
                                <div class="card bg-light">
                                    <div class="card-header"><i class="fas fa-calendar mr-2"></i>
                                        ...
                                        <div class="float-right" onclick="confirmDelete()">
                                            <form action="{{ route('kp.pengajuan.revisi.delete') }}" method="post">
                                                @csrf
    ...
    @if ($pengajuan->status == 'revisi' || $pengajuan->status == 'review')
        <div class="modal fade" id="modal-revisi">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="{{ route('kp.pengajuan.revisi') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="id" value="{{ $pengajuan->id }}">
                        <div class="modal-header">
    ...
    @if ($pengajuan->status == 'review')
        <div class="modal fade" id="modal-tolak">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="{{ route('kp.pengajuan.tolak') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="id" value="{{ $pengajuan->id }}">
                        <div class="modal-header">
        ...
        <div class="modal fade" id="modal-acc">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="{{ route('kp.pengajuan.acc') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="id" value="{{ $pengajuan->id }}">
                        <div class="modal-header">
    ...
    @if ($pengajuan->status == 'diterima')
        @if (count($mahasiswa->dosens()->whereIn('status', ['pembimbing', 'utama', 'pendamping'])->get()) == 0)
            <!-- Modal Ploting Dosen Pembimbing (1 Dosen untuk KP) -->
            <div class="modal fade" id="modal-edit">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form action="{{ route('kp.ploting.pembimbing') }}" method="post">
                            @csrf
                            <input type="hidden" name="id" value="{{ $pengajuan->id }}">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    <a href="{{ route('kp.bimbingan.rekap.dosen') }}" class="btn btn-primary btn-sm" target="_blank">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <select class="select-1" name="dosen_pembimbing" style="width: 100%;" required>
                                            ...
                                            @foreach ($dosens as $dosen)
                                                <option value="{{ $dosen->id }}"
                                                    @if ($currentDosen && $currentDosen->id == $dosen->id) selected @endif>
                                                    {{ $dosen->nama . ', ' . $dosen->gelar }}</option>
                                            @endforeach
                                        </select>
                                    </div>
        ...
        <div class="modal fade" id="modal-edit-judul">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="{{ route('kp.pengajuan.edit.judul', $pengajuan->id) }}" method="post">
                        @method('PUT')
                        @csrf
