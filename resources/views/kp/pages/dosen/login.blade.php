    ...
    <div class="container">
        ...
        <div class="d-flex justify-content-center mt-3">
            <div class="card p-3 col-md-5">
                ...
                <hr>
                <form action="{{ route('kp.cek.dosen') }}" method="post">
                    @csrf
                    <div class="form-group mb-3">
                        <label for="nim" class="form-label fw-semibold">NIDN</label>
                        <div class="input-group">
                            <span class="input-group-text" id="inputGroup-sizing-default"><i
                                    class="bi bi-person-fill"></i></span>
                            <input type="text" class="form-control" aria-label="Sizing example input"
                                aria-describedby="inputGroup-sizing-default" name="nidn" placeholder="Masukkan nidn..."
                                required>
                        </div>
                    </div>
                    <div class="form-group mb-3">
