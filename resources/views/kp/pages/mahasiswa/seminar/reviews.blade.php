            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Review Seminar KP</a></li>
                            ...
                            <div class="card card-primary card-outline">
                                ...
                                @if($review->status == 'review')
                                    <div class="card-footer">
                                       ...
                                       @else
                                       <a href="{{ route('kp.review.seminar.submit.acc.manual', $review->id) }}"
                                ...
                                @elseif ($review->status == null || $review->status == 'revisi')
                                    <div class="card-footer">
                                        <a href="{{ route('kp.review.seminar.edit', $review->id) }}"
                                            class="btn btn-primary col-md-12">
