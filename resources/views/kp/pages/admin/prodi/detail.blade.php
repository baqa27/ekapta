                                            ...
                                            <div class="d-flex">
                                                {{-- @if (count($bagian->bimbingans) == 0)
                                                    <div onclick="confirmActive()">
                                                        <form action="{{ route('kp.bagian.active') }}" method="post">
                                                            @csrf
                                                ...
                                                {{-- <a href="{{ route('kp.bagian.up', $bagian->id) }}" class="btn btn-secondary btn-sm">
                                                    <i class="fas fa-arrow-up"></i>
                                                </a>
                                                <a href="{{ route('kp.bagian.down', $bagian->id) }}" class="btn btn-secondary btn-sm">
