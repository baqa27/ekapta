...
@section('content')
                                                        ...
                                                        @if ($dekan->status == null)
                                                            @if ($dekanActive == null)
                                                                <div onclick="confirmActive()" class="mr-1">
                                                                    <form action="{{ route('kp.dekan.enabled') }}"
                                                                        method="post">
                                                                        @csrf
                                                            ...
                                                            <div onclick="confirmDelete()">
                                                                <form action="{{ route('kp.dekan.delete') }}"
                                                                    method="post">
                                                                    @csrf
                                                                    <input type="hidden" name="dekan"
                                                                        value="{{ $dekan->id }}">
                                                        ...
                                                        @elseif ($dekan->status == 'active')
                                                            <div class="d-flex">
                                                                ...
                                                                <div onclick="confirmDisable()">
                                                                    <form action="{{ route('kp.dekan.disabled') }}"
                                                                        method="post">
                                                                        @csrf
                                                                        <input type="hidden" name="dekan"
                                                                            value="{{ $dekan->id }}">
    ...
    <div class="modal fade" id="modal-create">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('kp.dekan.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
    ...
    <div class="modal fade" id="modal-import">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('kp.dekan.import') }}" method="post" enctype="multipart/form-data">
                    @csrf
    ...
    <div class="modal fade" id="modal-edit">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('kp.dekan.update') }}" method="post" enctype="multipart/form-data">
                    @csrf
