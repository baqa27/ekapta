...
@section('content')
                        ...
                        <table class="table table-bordered" id="tableSesi">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('kp.jadwal.himpunan.detail', $sesi->id) }}" class="btn btn-primary btn-sm">
                                        ...
                                        <button type="button" class="btn btn-danger btn-sm" onclick="hapusSesi({{ $sesi->id }})">
    ...
    <div class="modal fade" id="modal-buat-sesi">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form action="{{ route('kp.jadwal.himpunan.create') }}" method="POST">
                    @csrf
    ...
    @foreach($sesi_seminars as $sesi)
    @if(!$sesi->is_token_used)
    <form id="form-hapus-{{ $sesi->id }}" action="{{ route('kp.jadwal.himpunan.delete', $sesi->id) }}" method="POST" style="display: none;">
        @csrf
        @method('DELETE')
    </form>
    @endif
