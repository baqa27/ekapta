    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('ta.pengajuan.admin') }}"
                               class="nav-link {{ $module == 'ta' && $active == 'pengajuan-ta' ? 'active' : '' }}">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('ta.pendaftaran.admin') }}"
                               class="nav-link {{ $module == 'ta' && $active == 'pendaftaran-ta' ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('ta.bimbingan.admin.input') }}"
                               class="nav-link {{ $module == 'ta' && $active == 'bimbingan-input-ta' ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('ta.jilid.index') }}"
                               class="nav-link {{ $module == 'ta' && $active == 'jilid-ta' ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                ...
                {{-- MENU KERJA PRAKTIK --}}
                {{-- ============================================== --}}
                <li class="nav-item has-treeview {{ in_array($active, ['pengajuan-kp', 'pendaftaran-kp', 'bimbingan-kp', 'seminar-kp', 'bimbingan-input-kp', 'pengumpulan-akhir']) ? 'menu-open' : '' }}">
                    <a href="#" class="nav-link">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('kp.pengajuan.admin') }}"
                               class="nav-link {{ $module == 'kp' && $active == 'pengajuan-kp' ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Pengajuan KP</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('kp.pendaftaran.admin') }}"
                               class="nav-link {{ $module == 'kp' && $active == 'pendaftaran-kp' ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('kp.bimbingan.admin.input') }}"
                               class="nav-link {{ $module == 'kp' && $active == 'bimbingan-input-kp' ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('kp.pengumpulan-akhir.index') }}"
                               class="nav-link {{ $module == 'kp' && $active == 'pengumpulan-akhir' ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Jilid KP</p>
                            </a>
                        </li>
