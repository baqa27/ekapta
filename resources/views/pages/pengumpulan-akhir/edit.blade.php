                ...
                <div class="col-md-12">
                    @if (count($revisis) != 0)
                        <div class="p-2 border border-warning rounded mb-4">
                            <i class="fas fa-info-circle"></i> Pengajuan Pengumpulan Akhir KP Anda Berstatus REVISI. Silahkan submit ulang! <a href="{{ route('pengumpulan-akhir.detail.mahasiswa', $jilid->id) }}">Lihat Catatan Revisi <i class="fas fa-arrow-right"></i></a>
                        </div>
                    @endif
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            <form action="{{ route('pengumpulan-akhir.update', $jilid->id) }}" method="post"
                                enctype="multipart/form-data">
                                @method('put')
                                @csrf
                                <div class="form-group">
                                    <label for="exampleInputFile">Lembar Keaslian</label>
                                ...
                                <div class="form-group">
                                    <label for="exampleInputFile">Lembar Persetujuan Pembimbing (Dengan TTD)</label>
                                    <div class="input-group mb-3">
                                        <div class="custom-file">
                                            <input type="file"
                                ...
                                <div class="form-group">
                                    <label for="exampleInputFile">Lembar Persetujuan Penguji (Dengan TTD)</label>
                                    <div class="input-group mb-3">
                                        <div class="custom-file">
                                            <input type="file"
                                ...
                                <div class="form-group">
                                    <label for="exampleInputFile">Lembar Revisi Yang Sudah di ACC Semua Dosen Penguji (Dijadikan 1 file)</label>
                                    <div class="input-group mb-3">
                                        <div class="custom-file">
                                            <input type="file"
                                ...
                                <div class="form-group">
                                    <label for="exampleInputFile">Dokumen Lampiran (Opsional) <br><small>Upload dokumen lampiran pendukung KP seperti surat ijin KP, data KP, dokumen validasi, dll</small></label>
                                    <div class="input-group mb-3">
                                        <div class="custom-file">
                                            <input type="file"
