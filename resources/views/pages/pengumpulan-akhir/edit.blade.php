                ...
                <div class="col-md-12">
                    @if (count($revisis) != 0)
                        <div class="alert alert-warning alert-dismissible">
                            ...
                            <br>
                            <a href="{{ route('pengumpulan-akhir.detail.mahasiswa', $jilid->id) }}" class="btn btn-sm btn-outline-dark mt-2">
                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            <form action="{{ route('pengumpulan-akhir.update', $jilid->id) }}" method="post" enctype="multipart/form-data">
                                @method('put')
                                @csrf
