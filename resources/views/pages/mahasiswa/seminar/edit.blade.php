                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            <form action="{{ route('seminar.update', $seminar->id) }}" method="post"
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Bukti Lunas Pembayaran Seminar Kerja Praktik (KP) <b>Rp
                                            100.000</b>
                                        <br>
                                        <small>Pembayaran Seminar Kerja Praktik (KP) ke Juru bayar FASTIKOM (Mas Harri) di
                                ...
                                <div class="form-group">
                                    <label for="exampleInputFile">Berkas File Kerja Praktik Lengkap</label>
                                    <div class="input-group mb-3">
                                        <div class="custom-file">
                                            <input type="file"
                                ...
                                {{--                                <div class="form-group"> --}}
                                {{--                                    <label for="exampleInputFile"> Scan Lembar Bimbingan KP Yang Telah di Acc</label> --}}
                                {{--                                    <div class="input-group mb-3"> --}}
                                {{--                                        <div class="custom-file"> --}}
                                {{--                                            <input type="file" --}}
