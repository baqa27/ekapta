                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            <form action="{{ route('pendaftaran.update') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputFile">Sertifikat Peserta KP #1 (Seminar/Pelatihan)</label>
                                    <div class="input-group mb-3">
                                        <div class="custom-file">
                                            <input type="file"
                                                class="custom-file-input @error('sertifikat_peserta_1') is-invalid @enderror"
                                                name="sertifikat_peserta_1">
                                            <label class="custom-file-label" for="exampleInputFile">Choose
                                                file</label>
                                        </div>
                                        <div class="input-group-append">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputFile">Sertifikat Peserta KP #2 (Seminar/Pelatihan)</label>
                                    <div class="input-group mb-3">
                                        <div class="custom-file">
                                            <input type="file"
                                                class="custom-file-input @error('sertifikat_peserta_2') is-invalid @enderror"
                                                name="sertifikat_peserta_2">
                                            <label class="custom-file-label" for="exampleInputFile">Choose
                                                file</label>
                                        </div>
                                        <div class="input-group-append">
                                    ...
                                    <div class="rounded bg-light">
                                        <small>
                                            ...
                                            <a href="{{ storage_url($pendaftaran->sertifikat_peserta_2) }}" class="text-primary"
                                                target="_blank"><i class="fas fa-paperclip ml-2"></i>
                                                {{ Str::substr($pendaftaran->sertifikat_peserta_2, 21) }}</a>
                                            @else
                                            <span class="text-muted ml-2">Belum ada file</span>
                                            @endif
                                        </small>
