                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            ...
                            @if (!$bimbingan->lampiran_acc)
                                <form action="{{ route('bimbingan.submit.acc.manual.store') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group mt-4">
                                        <a href="{{ route('bimbingan.mahasiswa') }}" class="btn btn-secondary"><i class="fas fa-arrow-left mr-1"></i> Kembali</a>
