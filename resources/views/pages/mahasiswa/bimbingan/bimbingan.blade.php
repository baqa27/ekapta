...
@section('content')
    ...
    <div class="content-header">
        <div class="container">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Bimbingan Kerja Praktik</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                        ...
                        {{-- @if ($jilid)
                            @if ($jilid->status == 3)
                                <a href="#" class="btn btn-primary shadow mb-3"><i class="bi bi-check-circle "></i>
                                    PENGUMPULAN AKHIR SUDAH DI KONFIRMASI OLEH ADMIN. SILAHKAN TUNGGU PROSES SELESAI</a>
                            ...
                            @elseif ($jilid->status == 2)
                                <a href="{{ route('pengumpulan-akhir.edit', $jilid->id) }}" class="btn btn-primary shadow mb-3"><i
                                        class="bi bi-info-circle"></i> PENGUMPULAN AKHIR BERSTATUS REVISI. SILAHKAN SUBMIT
                                    ULANG</b></a>
                            @elseif ($jilid->status == 1)
                                <a href="#" class="btn btn-secondary shadow mb-3"><i
                                        class="bi bi-hourglass-bottom "></i> SUDAH MENGAJUKAN PENGUMPULAN AKHIR. SILAHKAN
                                    TUNGGU KONFIRMASI DARI ADMIN!</a>
                            @endif
                        @else
                            <a href="{{ route('pengumpulan-akhir.create') }}" class="btn btn-primary shadow mb-3"><i
                                    class="fas fa-book"></i> AJUKAN PENGUMPULAN AKHIR KP</a>
                        @endif --}}
                    @endif
