...
<body>
            ...
            <td height="60">
                <center>
                    <h4>LEMBAR PERSETUJUAN <br>
                        CALON DOSEN PEMBIMBING KERJA PRAKTIK (KP)
                    </h4>
                </center>
            </td>
        </tr>
    ...
    <table>
        ...
        <tr>
            <td colspan="3">
                <p class="margin-left">Untuk menjadi Pembimbing Kerja Praktik mahasiswa berikut: </p>
            </td>
        </tr>
        <tr>
            <td>
    ...
    <table align="center">
        <tr>
            @if($dosen_utama)
            <td height="60" width="{{ $dosen_pendamping ? '290' : '580' }}">
                <center>
                    <p>
