                                ...
                                @if($seminar->lampiran_3 || count($seminar->reviews) > 2)
                                     <div class="d-flex">
                                        ...
                                        <button type="button" class="btn btn-warning mr-2" data-toggle="modal"
                                            ...
                                            <i class="bi bi-calendar mr-2"></i> Tentukan Tanggal dan Tempat Seminar
                                        </button>
                                        ...
                                        &nbsp;
                                        <a href="{{ route('cetak.berita.acara.ujian.proposal.blank', [$seminar->id, 1]) }}"
        ...
        <div class="modal fade" id="modal-set-date-exam">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h4 class="modal-title">Tentukan Tanggal dan Tempat Seminar KP</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form action="{{ route('seminar.set.date.exam') }}" method="post">
                            ...
                            <div class="form-group mb-3">
                                <label for="" class="form-label">Tempat Seminar</label>
