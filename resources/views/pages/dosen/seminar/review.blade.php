                ...
                <div class="col-12">
                    ...
                    @if($review_seminar->status == 'diterima' || $review_seminar->dosen_status == 'pembimbing')
                        <div class="card card-primary card-outline mt-2">
                            ...
                            <div class="card-body">
                                <form action="{{ route('review.seminar.nilai') }}" method="post">
                                    @csrf
                                    <input type="hidden" name="id" value="{{ $review_seminar->id }}">
                                    <div class="row">
                                        <div class="col-md-3">
                                        ...
                                        <div class="float-right">
                                            <div class="d-flex">
                                                ...
                                                <div onclick="confirmDelete()">
                                                    <form action="{{ route('review.seminar.revisi.delete') }}"
                                                        method="post">
                                                        @csrf
    ...
    <div class="modal fade" id="modal-revisi">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('review.seminar.revisi.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="id" value="{{ $review_seminar->id }}">
