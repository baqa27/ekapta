                ...
                <div class="col-md-12">
                    ...
                    @if($review_ujian->status == 'diterima' || $review_ujian->dosen_status == 'pembimbing')
                        <div class="card card-primary card-outline mt-2">
                            ...
                            <div class="card-body">
                                <form action="{{ route('review.ujian.nilai') }}" method="post">
                                    @csrf
                                    <input type="hidden" name="id" value="{{ $review_ujian->id }}">
                                    <div class="row">
                                        <div class="col-md-3">
                                        ...
                                        <div class="float-right">
                                            <div class="d-flex">
                                                ...
                                                <div onclick="confirmDelete()">
                                                    <form action="{{ route('review.ujian.revisi.delete') }}"
                                                        method="post">
                                                        @csrf
    ...
    <div class="modal fade" id="modal-revisi">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('review.ujian.revisi.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="id" value="{{ $review_ujian->id }}">
