...
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('bimbingan.prodi.input') }}">Validasi Bimbingan</a></li>
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="mb-3">
                <a href="{{ route('bimbingan.prodi.input') }}" class="btn btn-secondary shadow">
                ...
                <div class="col-12">
                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-footer">
                            <div class="d-flex">
                                <a href="{{ route('bimbingan.prodi.input') }}" class="btn btn-secondary mr-2">
                                    <i class="fas fa-arrow-left mr-2"></i> Kembali
                                </a>
                                ...
                                @elseif ($bimbingan->status == 'diterima')
                                    <form action="{{ route('bimbingan.cancel.acc') }}" method="post" class="mr-2">
                                        @csrf
        ...
        <div class="modal fade" id="modal-acc">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="{{ route('bimbingan.acc.prodi') }}" method="post">
                        @csrf
                        <input type="hidden" name="id" value="{{ $bimbingan->id }}">
    ...
    @if ($bimbingan->status == 'review' || $bimbingan->status == 'revisi')
        <div class="modal fade" id="modal-revisi">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="{{ route('bimbingan.revisi.prodi') }}" method="post">
                        @csrf
                        <input type="hidden" name="id" value="{{ $bimbingan->id }}">
