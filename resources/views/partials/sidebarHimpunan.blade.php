...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    <a href="#" class="brand-link">
        ...
        <span class="brand-text font-weight-light">Panel Himpunan</span>
    </a>
    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="{{ route('dashboard.himpunan') }}" class="nav-link {{ $active == 'dashboard' ? 'active' : '' }}">
                        <i class="nav-icon fas fa-tachometer-alt"></i>
                        <p>Dashboard</p>
                    </a>
                </li>

                <li class="nav-item {{ in_array($active, ['seminar', 'jadwal']) ? 'menu-open' : '' }}">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('seminar.himpunan') }}" class="nav-link {{ $active == 'seminar' ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Verifikasi Pendaftaran</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('jadwal.himpunan') }}" class="nav-link {{ $active == 'jadwal' ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Penjadwalan Seminar</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('seminar.himpunan.rekap') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
