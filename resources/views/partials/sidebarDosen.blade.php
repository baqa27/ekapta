    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('kp.bimbingan.dosen.progress') }}"
                               class="nav-link {{ $active=='bimbingan-progress-kp' ? 'active' : '' }}">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('kp.penilaian.pembimbing.index') }}"
                               class="nav-link {{ $active=='penilaian-kp' ? 'active' : '' }}">
                                <i class="nav-icon far fa-circle"></i>
                ...
                {{-- MENU TUGAS AKHIR --}}
                {{-- ============================================== --}}
                <li class="nav-item has-treeview {{ in_array($active, ['bimbingan-ta', 'seminar-ta', 'ujian-ta', 'bimbingan-progress-ta']) ? 'menu-open' : '' }}">
                    <a href="#" class="nav-link">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('ta.bimbingan.dosen.progress') }}"
                               class="nav-link {{ $active=='bimbingan-progress-ta' ? 'active' : '' }}">
                                <i class="nav-icon far fa-circle"></i>
