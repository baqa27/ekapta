                ...
                <div class="col-md-12">
                    @if (count($revisis) != 0)
                        <div class="p-2 border border-warning rounded mb-4">
                            <i class="fas fa-info-circle"></i> Pengajuan Jilid Tugas Akhir Anda Berstatus REVISI. Silahkan submit ulang! <a href="{{ route('ta.jilid.detail.mahasiswa', $jilid->id) }}">Lihat Catatan Revisi <i class="fas fa-arrow-right"></i></a>
                        </div>
                    @endif
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('ta.jilid.update', $jilid->id) }}" method="post"
                                ...
                                <div class="form-group">
                                    <label for="exampleInputFile">Lembar Persetujuan Pembimbing (Dengan TTD) <br> <small><a href="{{ route('ta.cetak.lembar.persetujuan', 1) }}" target="_blank"><i class="fas fa-download"></i> Download Lembar Persetujuan Pembimbing</a></small></label>
                                    <div class="input-group mb-3">
                                        <div class="custom-file">
                                            <input type="file"
                                ...
                                <div class="form-group">
                                    <label for="exampleInputFile">Lembar Persetujuan Penguji (Dengan TTD) <br> <small><a href="{{ route('ta.cetak.lembar.persetujuan', 2) }}" target="_blank"><i class="fas fa-download"></i> Download Lembar Persetujuan Penguji</a></small></label>
                                    <div class="input-group mb-3">
                                        <div class="custom-file">
                                            <input type="file"
                                ...
                                <div class="form-group">
                                    <label for="exampleInputFile">Lembar Pengesahan (Dengan TTD) <br> <small><a href="{{ route('ta.cetak.lembar.pengesahan') }}" target="_blank"><i class="fas fa-download"></i> Download Lembar Pengesahan</a></small></label>
                                    <div class="input-group mb-3">
                                        <div class="custom-file">
                                            <input type="file"
                                ...
                                <div class="form-group">
                                    <label for="exampleInputFile">Lembar Bimbingan Pembimbing 1 dan 2 (Dijadikan 1 file)<br> <small><a href="{{ route('ta.cetak.riwayat.bimbingan.mahasiswa') }}" target="_blank"><i class="fas fa-download"></i> Download Lembar Bimbingan</a></small></label>
                                    <div class="input-group mb-3">
                                        <div class="custom-file">
                                            <input type="file"
                                ...
                                <div class="form-group">
                                    ...
                                    @if ($jilid->lampiran)
                                        <div class="rounded bg-light">
                                            <small>
                                                <span>Lampiran sebelumnya : </span>
                                                <a href="{{ asset($jilid->lampiran) }}" class="text-primary"
                                                    target="_blank"><i class="fas fa-paperclip ml-2"></i>
                                                    Lampiran</a>
                                            </small>
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    @if ($jilid->panduan)
                                        <div class="rounded bg-light">
                                            <small>
                                                <span>Lampiran sebelumnya : </span>
                                                <a href="{{ asset($jilid->panduan) }}" class="text-primary"
                                                    target="_blank"><i class="fas fa-paperclip ml-2"></i>
                                                    Lampiran</a>
                                            </small>
                                        </div>
