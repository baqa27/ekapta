...
@section('content')
                ...
                <div class="col-md-12">
                            ...
                            <div class="card-footer">
                                <div class="d-flex">
                                    ...
                                    {{--<div onclick="confirmAcc()">
                                        <form action="{{ route('ta.review.seminar.acc') }}" method="post">
                                            @csrf
                    ...
                    @if($review_seminar->status == 'diterima' || $review_seminar->dosen_status == 'pembimbing')
                        <div class="card card-primary card-outline mt-2">
                            ...
                            <div class="card-body">
                                <form action="{{ route('ta.review.seminar.nilai') }}" method="post">
                                    @csrf
                                    <input type="hidden" name="id" value="{{ $review_seminar->id }}">
                                    <div class="row">
                                        <div class="col-md-3">
                                        ...
                                        <div class="float-right">
                                            <div class="d-flex">
                                                ...
                                                <div onclick="confirmDelete()">
                                                    <form action="{{ route('ta.review.seminar.revisi.delete') }}"
                                                        method="post">
                                                        @csrf
    ...
    <div class="modal fade" id="modal-revisi">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('ta.review.seminar.revisi.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="id" value="{{ $review_seminar->id }}">
    ...
    <div class="modal fade" id="modal-acc">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('ta.review.seminar.acc') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="id" value="{{ $review_seminar->id }}">
                    <div class="modal-header">
