                                    ...
                                    <table id="example1" class="table table-bordered">
                                        ...
                                        <tbody>
                                            @php
                                                $no = 1;
                                            @endphp
                                            @foreach ($ujians_review as $review)
                                                <tr>
                                                    <td>{{ $no++ }}</td>
                                                    <td>
                                                        {{ $review->ujian->mahasiswa->nama }}
                                                        {{ '(' . $review->ujian->mahasiswa->nim . ')' }}
                                                    </td>
                                                    <td>
                                                        {{ $review->ujian->mahasiswa->prodi }}
                                                    </td>
                                                    <td>
                                                        {{ $review->ujian->pengajuan->judul }}
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        @if($review->dosen_status == 'penguji')
                                                            <a href="{{ route('ta.review.ujian.dosen', $review->id) }}"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            ...
                                                            @if($review->dosen_status == 'penguji' && $review->ujian->lampiran_laporan == null)
                                                                <div onclick="return confirmCancel()">
                                                                    <form action="{{ route('ta.review.ujian.cancel.acc') }}"
                                                                          method="post">
                                                                        @csrf
                                    ...
                                    <table id="example3" class="table table-bordered">
                                        ...
                                        <tbody>
                                            @php
                                                $no = 1;
                                            @endphp
                                            @foreach ($ujians_revisi as $review)
                                                <tr>
                                                    <td>{{ $no++ }}</td>
                                                    <td>
                                                        {{ $review->ujian->mahasiswa->nama }}
