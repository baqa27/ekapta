...
@section('content')
                                                        ...
                                                        @if ($dekan->status == null)
                                                            @if ($dekanActive == null)
                                                                <div onclick="confirmActive()" class="mr-1">
                                                                    <form action="{{ route('ta.dekan.enabled') }}"
                                                                        method="post">
                                                                        @csrf
                                                            ...
                                                            <div onclick="confirmDelete()">
                                                                <form action="{{ route('ta.dekan.delete') }}"
                                                                    method="post">
                                                                    @csrf
                                                                    <input type="hidden" name="dekan"
                                                                        value="{{ $dekan->id }}">
                                                        ...
                                                        @elseif ($dekan->status == 'active')
                                                            <div class="d-flex">
                                                                ...
                                                                <div onclick="confirmDisable()">
                                                                    <form action="{{ route('ta.dekan.disabled') }}"
                                                                        method="post">
                                                                        @csrf
                                                                        <input type="hidden" name="dekan"
                                                                            value="{{ $dekan->id }}">
    ...
    <div class="modal fade" id="modal-create">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('ta.dekan.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
    ...
    <div class="modal fade" id="modal-import">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('ta.dekan.import') }}" method="post" enctype="multipart/form-data">
                    @csrf
    ...
    <div class="modal fade" id="modal-edit">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('ta.dekan.update') }}" method="post" enctype="multipart/form-data">
                    @csrf
