...
@section('content')
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($dosen->is_manual == 1)
                                                    <a href="{{ route('ta.dosen.change.manual', $dosen->id) }}"
                                                ...
                                                @endif
                                                <a href="{{ route('ta.dosen.edit', $dosen->id) }}"
                                                    class="btn btn-primary btn-sm shadow">
                                                    <i class="bi bi-gear mr-1"></i> Setting
                                                </a>
                                                <a href="{{ route('ta.dosen.reset.password', $dosen->id) }}"
    ...
    <div class="modal fade" id="modal-import">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('ta.dosen.import') }}" method="post" enctype="multipart/form-data">
                    @csrf
    ...
    <div class="modal fade" id="modal-import-penugasan">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('ta.dosen.prodi.import') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-header">
