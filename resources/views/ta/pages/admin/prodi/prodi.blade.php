                                    ...
                                    @foreach ($prodis as $prodi)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('ta.prodi.presentase.nilai' , $prodi->id) }}"
                                                    class="btn btn-warning btn-sm shadow">
                                                    <i class="fas fa-star"></i> Presentase Nilai
                                                </a>
                                                <a href="{{ route('ta.prodi.reset.password' , $prodi->id) }}"
    ...
    <div class="modal fade" id="modal-import">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('ta.prodi.import') }}" method="post" enctype="multipart/form-data">
                    @csrf
