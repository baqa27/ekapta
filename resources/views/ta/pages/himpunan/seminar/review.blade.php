...
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('ta.seminar.himpunan') }}">Seminar KP</a></li>
                ...
                <div class="col-12">
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-footer">
                            <div class="d-flex">
                                <a href="{{ route('ta.seminar.himpunan') }}" class="btn btn-secondary mr-2">
                                ...
                                @if ($seminar->is_valid == 1)
                                    <a href="{{ route('ta.jadwal.himpunan') }}" class="btn btn-primary">
    ...
    <div class="modal fade" id="modal-revisi">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('ta.seminar.himpunan.revisi') }}" method="post">
                    @csrf
    ...
    <div class="modal fade" id="modal-acc">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('ta.seminar.himpunan.acc') }}" method="post">
                    @csrf
                    <input type="hidden" name="id" value="{{ $seminar->id }}">
                    <div class="modal-header">
