            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            <form action="{{ route('seminar.update.proposal', $seminar->id) }}" method="post" enctype="multipart/form-data">
                                @method('PUT')
                                @csrf
                                ...
                                <div class="form-group">
                                    <label for="exampleInputFile">Laporan Seminar Proposal</label>
                                    ...
                                    @if ($seminar->lampiran_proposal)
                                        <div class="bg-light p-2 rounded">
                                            <small>
                                                ...
                                                <a href="{{ asset($seminar->lampiran_proposal) }}" class="ml-3 text-primary"
                                ...
                                <div class="form-group mt-4">
                                    <a href="{{ route('ta.seminar.mahasiswa') }}" class="btn btn-secondary">Kembali</a>
