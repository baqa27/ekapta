<nav class="main-header navbar navbar-expand-md navbar-light navbar-white sticky-top">
    <div class="container">
        <a href="{{ route('ta.dashboard.mahasiswa') }}" class="navbar-brand">
        ...
        <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto mr-3">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    ...
                    <a href="{{ route('ta.profile') }}" class="dropdown-item">
                        <i class="far fa-user mr-2"></i> Profile
                    </a>
                    <a href="{{ route('ta.mahasiswa.account') }}" class="dropdown-item">
